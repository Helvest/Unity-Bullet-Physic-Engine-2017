    ...
    public class Anchor
    {
        ...
        public Node Node
        {
            get
            {
                ...
                if (_node != null && _node._native == nodePtr)
                {
                    return _node;
                }
    ...
    public class Body : IDisposable
    {
        ...
        public Cluster Soft
        {
            get
            {
                ...
                if (_soft != null && _soft._native == softPtr)
                {
                    return _soft;
                }
    ...
    public class Cluster
    {
        ...
        public DbvtNode Leaf
        {
            get
            {
                ...
                if (_leaf != null && _leaf._native == leafPtr)
                {
                    return _leaf;
                }
    ...
    public class Feature : Element
    {
        ...
        public Material Material
        {
            get
            {
                ...
                if (_material != null && _material._native == materialPtr)
                {
                    return _material;
                }

...
namespace BulletSharp
{
	...
	{
		internal DefaultMotionState(IntPtr native) : base(native)
		{
		}

		public DefaultMotionState() : base(btDefaultMotionState_new())
		{
		}

		public DefaultMotionState(Matrix startTrans) : base(btDefaultMotionState_new2(ref startTrans))
		{
		}

		public DefaultMotionState(Matrix startTrans, Matrix centerOfMassOffset) : base(btDefaultMotionState_new3(ref startTrans, ref centerOfMassOffset))
		{
		}

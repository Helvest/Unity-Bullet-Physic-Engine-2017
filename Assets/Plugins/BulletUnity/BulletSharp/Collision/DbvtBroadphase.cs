...
namespace BulletSharp
{
	...
	{
		internal DbvtProxy(IntPtr native) : base(native)
		{
		}
		...
		public DbvtNode Leaf
		{
			...
			set
			{
				btDbvtProxy_setLeaf(_native, (value != null) ? value._native : IntPtr.Zero);
			}
		}
		/*
	...
	{
		public DbvtBroadphase() : base(btDbvtBroadphase_new())
		{

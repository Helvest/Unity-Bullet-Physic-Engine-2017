...
namespace BulletSharp
{
	public class GhostObject : CollisionObject
	{
		...
		internal GhostObject(IntPtr native) : base(native)
		{
		}

		public GhostObject() : base(btGhostObject_new())
		{
		}
	...
	public class PairCachingGhostObject : GhostObject
	{
		...
		public PairCachingGhostObject() : base(btPairCachingGhostObject_new())
		{
		}
	...
	{
		internal GhostPairCallback(IntPtr native) : base(native)
		{
		}

		public GhostPairCallback() : base(btGhostPairCallback_new())
		{
		}

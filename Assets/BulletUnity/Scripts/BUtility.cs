		...
		public static void DebugDrawPatch(Vector3 position, Quaternion rotation, Vector3 scale, Vector3 c00, Vector3 c01, Vector3 c10, Vector3 c11, int resX, int resY, Color color)
		{
			...
			for (int iy = 0; iy < resY; ++iy)
			{
				for (int ix = 0; ix < resX; ++ix)
				{
					...
					Vector3 py0_00 = Vector3.Lerp(c00, c01, ty_00);
					Vector3 py1_00 = Vector3.Lerp(c10, c11, ty_00);
					...
					Vector3 py0_01 = Vector3.Lerp(c00, c01, ty_01);
					Vector3 py1_01 = Vector3.Lerp(c10, c11, ty_01);
					...
					Vector3 py0_10 = Vector3.Lerp(c00, c01, ty_10);
					Vector3 py1_10 = Vector3.Lerp(c10, c11, ty_10);
					...
					Vector3 py0_11 = Vector3.Lerp(c00, c01, ty_11);
					Vector3 py1_11 = Vector3.Lerp(c10, c11, ty_11);

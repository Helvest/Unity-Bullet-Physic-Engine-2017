...
namespace BulletUnity
{
    ...
    */
	...
	public class BRigidBody : BCollisionObject, IDisposable
	{
		...
		private BulletSharp.Math.Vector3 _localInertia = BulletSharp.Math.Vector3.Zero;
		...
		[SerializeField]
		private UnityEngine.Vector3 _linearFactor = UnityEngine.Vector3.one;
		...
		[SerializeField]
		private UnityEngine.Vector3 _angularFactor = UnityEngine.Vector3.one;
        ...
        */
		public bool CreateOrConfigureRigidBody(ref RigidBody rb, ref BulletSharp.Math.Vector3 localInertia, CollisionShape cs, MotionState motionState)
		{
			...
			if (rb == null)
			{
				...
				if (motionState == null)
				{
					...
					rb.WorldTransform = Matrix.AffineTransformationCustom(ref position, ref rotation, ref scale);
				}
		...
		internal override bool _BuildCollisionObject()
		{
			...
			{
				Debug.LogWarning("isStatic: " + name);
			}
